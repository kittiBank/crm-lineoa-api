#!/usr/bin/env bash
# Render production .env for GCP docker-compose.prod.yml
...
CORS_ORIGINS="${CORS_ORIGINS:-https://crm-lineoa-web.vercel.app}"
...
S3_PUBLIC_URL="${S3_PUBLIC_URL:-https://storage.googleapis.com/${S3_BUCKET}}"
